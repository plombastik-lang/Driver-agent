const CACHE='driver-agent-v5.6-20260830-1';
const ASSETS=['./','./index.html','./styles.css?v=5.6','./app.js?v=5.6','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
