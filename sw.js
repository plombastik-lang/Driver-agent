const CACHE='driver-agent-v2.7-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=2.7','./app.js?v=2.7','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
