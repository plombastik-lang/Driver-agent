const CACHE='driver-agent-v6.7-20260830-1';
const ASSETS=['./','./index.html','./styles.css?v=6.7','./app.js?v=6.7','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
