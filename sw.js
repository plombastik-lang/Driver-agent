const CACHE='driver-agent-v4.1-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=3.9','./app.js?v=3.9','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
