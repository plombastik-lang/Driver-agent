const CACHE='driver-agent-v7.0-20260831-1';
const ASSETS=['./','./index.html','./styles.css?v=7.0','./app.js?v=7.0','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
