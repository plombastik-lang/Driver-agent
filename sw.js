const CACHE='driver-agent-v2.9-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=2.9','./app.js?v=2.9','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
