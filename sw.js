const CACHE='driver-agent-v2.2-20260828-1';
const ASSETS=['./','./index.html','./styles.css?v=2.2','./app.js?v=2.2','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
