const CACHE='driver-agent-v3.1-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=3.1','./app.js?v=3.1','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
