const CACHE='driver-agent-v5.0-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=4.7','./app.js?v=4.7','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
