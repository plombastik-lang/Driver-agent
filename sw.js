const CACHE='driver-agent-v4.6-20260829-1';
const ASSETS=['./','./index.html','./styles.css?v=4.6','./app.js?v=4.6','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
