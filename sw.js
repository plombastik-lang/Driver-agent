const CACHE='driver-agent-v6.9-20260831-1';
const ASSETS=['./','./index.html','./styles.css?v=6.9','./app.js?v=6.9','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
