importScripts('./config.js?v=7.2');
const CACHE=`driver-agent-v${globalThis.DRIVER_AGENT_VERSION}-20260831-2`;
const ASSETS=['./','./index.html','./config.js?v=7.2','./styles.css?v=7.2','./app.js?v=7.2','./manifest.webmanifest','./icon-180.png','./icon-192.png','./icon-512.png'];
